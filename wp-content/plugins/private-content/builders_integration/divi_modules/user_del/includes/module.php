...
class pc_user_del_divi_module extends ET_Builder_Module {

	public $slug       = 'pc_user_del';
	...
	public function init() {
		$this->name               = 'PC - '. esc_html__('User Deletion Form', 'pc_ml');
