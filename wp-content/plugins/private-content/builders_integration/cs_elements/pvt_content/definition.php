...
class lcweb_pc_pvt_content {

	public function ui() {
		return array(
		  'title'       => 'PC - '. esc_html__('Restricted Content', 'pc_ml'),
		  'autofocus' => array(
				'heading' => 'h4.lcweb_pc_pvt_content-heading',
				'content' => '.lcweb_pc_pvt_content'
			),
			'icon_group' => 'lcweb_pc_pvt_content'
		);
	}
