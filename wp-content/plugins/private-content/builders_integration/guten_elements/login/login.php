...
register_block_type('lcweb/pc-login-form', array(
	'editor_script' 	=> 'pc_login_on_guten',
	'render_callback' 	=> 'pvtcont_login_guten_handler',
	'attributes' 		=> $defaults
));


wp_localize_script('wp-blocks', 'pc_login_defaults', $defaults);
