(function($) { 
					...
					callbacks	: {
					  ...
					  open : function() {
						...
						$(lb_class+' .pc_scw_choser option').each(function() {
							...
							if(!$(this).is(':selected')) {
								$(lb_class +' '+ val).addClass('pc_displaynone');	
							} else {
								$(lb_class +' '+ val).removeClass('pc_displaynone');		
							}
						});
	...
	$(document).on("change", "#pc_sc_allow", function() {
		...
		if(unlogged_chosen || !val.length) {
			$('.pc_sc_block_wrap').addClass('pc_displaynone');	
		} else {
			$('.pc_sc_block_wrap').removeClass('pc_displaynone');	
		}
	});
	...
	$(document).on('lcs-statuschange', '#pg-hide-warning', function() {
		if( $(this).is(':checked') ) {
			$('.pc_scw_wb_row').addClass('pc_displaynone');
		} else {
			$('.pc_scw_wb_row').removeClass('pc_displaynone');	
		}
	});
